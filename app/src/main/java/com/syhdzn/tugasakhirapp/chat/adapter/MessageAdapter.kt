...
class MessageAdapter(private val listOfMessage: List<Message>, private val currentUserId: String) : RecyclerView.Adapter<MessageHolder>() {
    ...
    override fun getItemViewType(position: Int): Int {
        return if (listOfMessage[position].senderId == currentUserId) RIGHT else LEFT
    }
}
